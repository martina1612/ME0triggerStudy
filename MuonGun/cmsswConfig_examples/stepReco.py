...
process.me0RecHits = cms.EDProducer("ME0RecHitProducer",
    ...
    #me0DigiLabel = cms.InputTag("simMuonME0PadDigis", "", "DIGI"), # 20022018
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
        #'file:/afs/cern.ch/work/m/mressego/private/ME0trigger/CMSSW_9_3_3/src/samples/localSamples/promptMu/step2_5.root'
	#'file:../localSamples/promptMu/step2_5.root'
	'file:step2.root'
...
### Paths and Schedules
#######################
process.rechit_step  = cms.Path(process.me0RecHits+process.me0LocalReco)   # (process.localreco+process.gemRecHits+process.me0LocalReco)
