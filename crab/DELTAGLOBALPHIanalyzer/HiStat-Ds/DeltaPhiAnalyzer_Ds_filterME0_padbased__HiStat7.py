...
config.General.requestName = 'DeltaGlobalPhiAnalyzer_Ds_filterME0_padbased__HiStat7'
...
config.Data.inputDataset = '/ME0trigger/mressego-DsToTau_To3Mu_beamspot14TeV_filterME0_padbased-step3_100evt__HiStat7_FEVTDEBUGHLToutput-61cff2b17b7157f560edc7ff8cf1c306/USER'
config.Data.inputDBS = 'https://cmsweb.cern.ch/dbs/prod/phys03/DBSReader'
#job_control
config.Data.publication = False #whether to publish EDM output files to DBS
config.Data.outputDatasetTag = 'DeltaGlobalPhiAnalyzer_Ds_filterME0_padbased__HiStat7'
