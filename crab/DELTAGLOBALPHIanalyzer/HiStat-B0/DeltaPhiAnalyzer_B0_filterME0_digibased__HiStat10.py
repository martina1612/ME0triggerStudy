...
config.General.requestName = 'DeltaGlobalPhiAnalyzer_B0_filterME0_digibased__HiStat10'
...
config.Data.inputDataset = '/ME0trigger/mressego-B0ToTau_To3Mu_beamspot14TeV_filterME0_digibased-step3_100evt__HiStat10_FEVTDEBUGHLToutput-0ca0c7f22478c521b70ed98356042824/USER'
config.Data.inputDBS = 'https://cmsweb.cern.ch/dbs/prod/phys03/DBSReader'
#job_control
config.Data.publication = False #whether to publish EDM output files to DBS
config.Data.outputDatasetTag = 'DeltaGlobalPhiAnalyzer_B0_filterME0_digibased__HiStat10'
