...
config.General.requestName = 'DeltaGlobalPhiAnalyzer_B0_minBias_singlePhotonCalAging300'
...
config.Data.inputDataset = '/SinglePhoton_Pt-500/PhaseIITDRSpring17DR-PU200CalAging300_91X_upgrade2023_realistic_v3-v2/GEN-SIM-RECO'
config.Data.inputDBS = 'global'
#job_control
config.Data.publication = False #whether to publish EDM output files to DBS
config.Data.outputDatasetTag = 'DeltaGlobalPhiAnalyzer_B0_minBias_singlePhotonCalAging300'
